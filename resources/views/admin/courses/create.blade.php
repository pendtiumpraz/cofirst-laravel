    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
        <div class="p-6">
            <div class="mb-6">
                ...
                <p class="text-gray-600">Add a new course to the system</p>
            </div>
            ...
            <form method="POST" action="{{ route('admin.courses.store') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="number" name="duration_hours" id="duration_hours" value="{{ old('duration_hours') }}" min="1"
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('duration_hours') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <select name="level" id="level" 
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('level') border-red-500 @enderror">
