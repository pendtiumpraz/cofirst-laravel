...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-600">Manage all materials and their details</p>
        </div>
        <a href="{{ route('admin.materials.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition-colors inline-flex items-center">
        ...
        <div class="p-6">
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="h-10 w-10 flex-shrink-0 bg-gradient-to-r from-teal-400 to-blue-500 rounded-full flex items-center justify-center">
                                                    <span class="text-sm font-medium text-white">{{ substr($material->title, 0, 1) }}</span>
                                                </div>
                                                <div class="ml-4">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <div class="text-sm text-gray-500">Meeting {{ $material->syllabus->meeting_number }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Get started by creating your first learning material.</p>
                    <div class="mt-6">
