                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="type" id="type" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                    <option value="private" {{ old('type') == 'private' ? 'selected' : '' }}>Private (1-on-1)</option>
                                    <option value="group" {{ old('type') == 'group' ? 'selected' : '' }}>Group (Max 5 Students)</option>
                                    <option value="extracurricular" {{ old('type') == 'extracurricular' ? 'selected' : '' }}>Extracurricular (School)</option>
                                </select>
                            </div>
                            <div>
